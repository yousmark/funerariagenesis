      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h1 class="box-title">Cotizaciones <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nueva</button></h1>
          ...
          <div class="box-body">
            ...
            <div class="panel-body" style="height: auto;" id="formularioregistros">
              <form name="formulario" id="formulario" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="fecha_fallecimiento" id="fecha_fallecimiento" 
                             max="" min="">
                      <small class="help-block-info"><i class="fa fa-info-circle"></i> Máximo 4 días en el pasado</small>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <h4 class="bg-primary" style="padding:10px; color:white; margin:15px 0;">Datos de la Familia</h4>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="direccion_familia" id="direccion_familia">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="contacto_email" id="contacto_email"
                             data-validacion="email" placeholder="ejemplo@dominio.com">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <h4 class="bg-primary" style="padding:10px; color:white; margin:15px 0;">Servicios y Productos</h4>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <small class="help-block">Marque los servicios que desea incluir en la cotización</small>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="number" step="0.01" class="form-control" name="subtotal" id="subtotal" 
                             readonly style="background-color: #f5f5f5; font-weight: bold;" min="0" placeholder="0.00">
                      <small class="help-block-info"><i class="fa fa-info-circle"></i> Subtotal de servicios</small>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input type="number" step="0.01" class="form-control" name="valor_descuento" id="valor_descuento" 
                             min="0" placeholder="0.00" disabled>
                      <small class="help-block-info"><i class="fa fa-info-circle"></i> Ingrese el descuento</small>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                      <label>Descuento (Bs)</label>
                      <input type="number" step="0.01" class="form-control" name="descuento_bs" id="descuento_bs" 
                             readonly style="background-color: #fff3cd; font-weight: bold; color: #856404;" min="0" placeholder="0.00">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="number" step="0.01" class="form-control" name="total" id="total" 
                             data-validacion="soloNumeros" required min="0" placeholder="0.00" 
                             style="background-color: #d4edda; font-weight: bold; font-size: 16px;">
                      <small class="help-block-info"><i class="fa fa-info-circle"></i> Total con descuento aplicado</small>
                    </div>
                  </div>
                </div>
