...
$sql = "CREATE TABLE IF NOT EXISTS `documento_registro_civil` (
...
try {
    ...
    if ($result) {
        echo "<h2 style='color:green;'>✓ Tabla 'documento_registro_civil' creada exitosamente</h2>";
    } else {
        echo "<h2 style='color:red;'>✗ Error al crear la tabla</h2>";
